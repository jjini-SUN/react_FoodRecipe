...
export default function GlobalState({children}) {
    ...
    let [copyFavoritesList, setCopyFavoritesList] = useState([]);
    ...
    // state의 배열은 직접 수정 X ==> ...으로 분리하고 []로 감싸서 카피본으로 수정 [...]
    ...
    function hAddToFavorite(getCurItem) {
        ...
        const index = copyFavoritesList.findIndex(e=>e.id === getCurItem.id);  //못찾으면 -1, 찾으면 해당 위치 return
